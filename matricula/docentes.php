                ...
                <td>
                    <div class="row-fluid">
                      <div class="span6">
                        	...
                        	Registro & Control de Docentes</h3>
                      </div>
                      <div class="span6">
                      	<div align="right">
                       	<a href="crear_docente.php" class="btn">
                            ...
                            <ul class="dropdown-menu">
                              <?php
									...
									while($d=mysql_fetch_array($c)){
										echo '<li><a href="docentes.php?cursos='.$d['id'].'">'.$d['nombre'].'</a></li>';	
									}
							?>
                            <li><a href="docentes.php?cursos=0">Todos</a></li>
                            </ul>
                        </div>
                        <br><br>
                        <form name="form1" method="post" action="">
                            <div class="input-prepend">
                                ...
                                <input name="bus" type="text" placeholder="Buscar Docente" class="input-xlarge" autocomplete="off">
                            </div>
                        </form>
                        </div>
                      </div>
                  ...
                  <!--actualizar alumno-->
                    ...
                    <form name="form2" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 id="myModalLabel">Actualizar Docente</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row-fluid">
                                <div class="span6">
                                    ...
                                    <strong>Aréa de Trabajo</strong><br>
                                    <select name="curso">
                                    	<?php
											$c=mysql_query("SELECT * FROM salones WHERE estado='s'");
											while($d=mysql_fetch_array($c)){
                                ...
                                <div class="span6">
                                    <strong>Apellidos del Docente</strong><br>
        ...
        <ul>
			...
			if(empty($_GET['cursos']) and empty($_POST['bus'])){
				$tp = ceil($total/$maximo);#funcion que devuelve entero redondeado
         		for	($n=1; $n<=$tp ; $n++){
					if($pag==$n){
						echo '<li class="active"><a href="docentes.php?pag='.$n.'">'.$n.'</a></li>';	
					}else{
						echo '<li><a href="docentes.php?pag='.$n.'">'.$n.'</a></li>';	
					}
				}
...
<form name="form2" method="post" enctype="multipart/form-data" action="">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel">Ingresar Nuevo Docente</h3>
	</div>
	<div class="modal-body">
		<div class="row-fluid">
        	<div class="span6">
  	...
  	<div class="modal-footer">
		<button class="btn" data-dismiss="modal" aria-hidden="true"><strong><i class="icon-remove"></i> Cerrar</strong></button>
        <button type="submit" class="btn"><strong><i class="icon-ok"></i> Ingresar Docente</strong></button>
	</div>
    </form>
</div>
</body>
